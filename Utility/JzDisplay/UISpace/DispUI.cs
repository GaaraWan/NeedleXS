...
namespace JzDisplay.UISpace
{
    public partial class DispUI : UserControl
    {
        ...
        public void Initial(float maxratio,float minratio)
        {
            ...
            //OPDISP.DebugClickPointAction += OPDISP_DebugClickPointAction;
            picDisplay.MouseDown += picDisplay_MouseDown;
            OPDISP.OnFireMessage += OPDISP_OnFireMessage;


        }

        private void OPDISP_OnFireMessage(object sender, DisplayEventArgs e)
        {
            FireDisplayMessage(e);
        }

        //private void OPDISP_DebugClickPointAction(PointF ptLocation, MouseButtons eMyMouseButtons)
        //{
        //    OnClickDebug(ptLocation, eMyMouseButtons);
        //}
        public void SetControlPara(string eStr)
        {
            if (!string.IsNullOrEmpty(eStr))
                OPDISP.SetControlPara(eStr);
        }
