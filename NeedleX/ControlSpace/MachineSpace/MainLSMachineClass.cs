...
namespace Traveller106.ControlSpace.MachineSpace
{
    public class MainLSMachineClass : GeoMachineClass
    {
        const int MSDuriation = 10;

        public MainLSIOClass PLCIO;
        public EventClass EVENT;

        public MainLSMachineClass(Machine_EA machineea, string opstr, string workpath, bool isnouseplc)
        {
